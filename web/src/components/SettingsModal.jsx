...
const FIELDS = [
  ...
  {
    key: 'takeover.reminder_repeat_minutes',
    label: 'Повтор напоминания менеджеру (мин)',
    hint: 'Пока менеджер молчит, напоминание повторяется с этим интервалом — до самого подхвата Эммой.',
  },
]
